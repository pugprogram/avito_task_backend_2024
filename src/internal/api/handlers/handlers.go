...
func (siw *ServerInterfaceWrapper) EditBid(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "bidId", r.PathValue("bidId"), &bidId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetBidsForTender(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "tenderId", r.PathValue("tenderId"), &tenderId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/bids/my", wrapper.GetUserBids)
	m.HandleFunc("POST "+options.BaseURL+"/bids/new", wrapper.CreateBid)
	m.HandleFunc("PATCH "+options.BaseURL+"/bids/{bidId}/edit", wrapper.EditBid)
	m.HandleFunc("PUT "+options.BaseURL+"/bids/{bidId}/feedback", wrapper.SubmitBidFeedback)
	m.HandleFunc("PUT "+options.BaseURL+"/bids/{bidId}/rollback/{version}", wrapper.RollbackBid)
	m.HandleFunc("GET "+options.BaseURL+"/bids/{bidId}/status", wrapper.GetBidStatus)
	m.HandleFunc("PUT "+options.BaseURL+"/bids/{bidId}/status", wrapper.UpdateBidStatus)
	m.HandleFunc("PUT "+options.BaseURL+"/bids/{bidId}/submit_decision", wrapper.SubmitBidDecision)
	m.HandleFunc("GET "+options.BaseURL+"/bids/{tenderId}/list", wrapper.GetBidsForTender)
	m.HandleFunc("GET "+options.BaseURL+"/bids/{tenderId}/reviews", wrapper.GetBidReviews)
	m.HandleFunc("GET "+options.BaseURL+"/ping", wrapper.CheckServer)
	m.HandleFunc("GET "+options.BaseURL+"/tenders", wrapper.GetTenders)
	m.HandleFunc("GET "+options.BaseURL+"/tenders/my", wrapper.GetUserTenders)
	m.HandleFunc("POST "+options.BaseURL+"/tenders/new", wrapper.CreateTender)
	m.HandleFunc("PATCH "+options.BaseURL+"/tenders/{tenderId}/edit", wrapper.EditTender)
	m.HandleFunc("PUT "+options.BaseURL+"/tenders/{tenderId}/rollback/{version}", wrapper.RollbackTender)
	m.HandleFunc("GET "+options.BaseURL+"/tenders/{tenderId}/status", wrapper.GetTenderStatus)
	m.HandleFunc("PUT "+options.BaseURL+"/tenders/{tenderId}/status", wrapper.UpdateTenderStatus)
